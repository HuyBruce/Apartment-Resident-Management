...
public class Resident {
    ...
    public void setRelationship_to_apartment(String r) { this.relationship_to_apartment = r; }
    ...
    public void setApartment_id(long apartment_id) { this.apartment_id = apartment_id; }
